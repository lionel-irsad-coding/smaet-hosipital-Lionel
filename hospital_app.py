...
st.set_page_config(page_title="Smart_Hospital", page_icon="🏥", layout="wide")
...
DEPT_INFO = {
    'Respiratory Medicine': {
        ...
        'desc':'Specialises in conditions affecting the lungs and always',
...
with st.form("triage_form"):
    ...
    st.markdown("""
    <!-- COLOR2 -->
    <div style="background:#6efff3;border:1px solid #3aeb90;border-radius:14px;
                padding:20px 24px;margin-bottom:20px;">
        <div style="display:flex;align-items:center;gap:10px;margin-bottom:4px;">
            <span style="background:#29d4a7;color:white;border-radius:8px;
                         padding:4px 10px;font-size:12px;font-weight:600;">1</span>
            <span style="font-size:16px;font-weight:600;color:#2200ff;">what are your main symptoms?</span>
    ...
    <div style="background:#ccfcff;border:1px solid #5ae7e0;border-radius:14px;
                padding:20px 24px;margin-bottom:20px;">
        <div style="display:flex;align-items:center;gap:10px;margin-bottom:4px;">
            <span style="background:#51fae9;color:rgb(0, 64, 254);border-radius:8px;
    ...
    <div style="background:#a9e2f8;border:1px solid #eff2d1;border-radius:14px;
        ...
        <div style="display:flex;align-items:center;gap:10px;margin-bottom:4px;">
            ...
            <span style="font-size:16px;font-weight:600;color:#484d58;">Do you have any of the following</span>
        </div>
    </div>
    """, unsafe_allow_html=True)
    ...
    with ch2: heart_disease = st.checkbox("❤️ Hearth Disease")
    ...
    st.markdown("""
    <!-- COLOR6 -->
    <div style="background:#becbff;border:1px solid #71fffa;border-radius:14px;
                padding:20px 24px;margin-bottom:20px;">
        <div style="display:flex;align-items:center;gap:10px;margin-bottom:4px;">
            <span style="background:#0ae3f2;color:white;border-radius:8px;
                         padding:4px 10px;font-size:12px;font-weight:600;">5</span>
            <span style="font-size:16px;font-weight:600;color:#2b2d33;">Patient information</span>
        </div>
    </div>
    """, unsafe_allow_html=True)
...
if submitted:
    ...
    <div style="font-size:14px;color:#6b7280;margin-bottom:1.5rem;">Base on the information you provided</div>
    """, unsafe_allow_html=True)
